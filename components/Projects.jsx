import { assets, personalProjectData } from '@/assets/assets'
    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                A showcase of independent projects that highlight my skills in building engaging, high-quality web applications.
            </motion.p>
            ...
            <motion.div
                ...
                {personalProjectData.slice(0, visibleProjects).map((project, index) => (
                    <a
                        key={index}
                        href={project.link}
                        target='_blank'
